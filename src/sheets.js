 ...
 * Retorna array de objetos com: nome, email, entrada, saida, equipeNome, equipeId
...
async function getEscala() {
  ...
  // Linha 0 = cabeçalho
  // A=Nome, B=Email, C=Subarea, D=Cargo, E=Entrada, F=Saida, G=equipe_distribuicao, H=id_equipe_distribuicao
  const escala = [];
  for (let i = 1; i < rows.length; i++) {
    ...
    // Ignora linha sem email ou sem id de equipe
